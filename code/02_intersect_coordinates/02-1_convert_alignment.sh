...
# SET VARIABLES
hal_file="/proj/snic2020-16-24/private/users/minna/master_thesis/data/Zoonomia_alignment/8-t2t-apes-2023v2.hal"
...
# CONVERT ALIGNMENT FILE TO MAF-FORMAT
hal2maf "$hal_file" "$maf_file" --refGenome hg38 


# CONVERT MAF-FORMATTED ALIGNMENTFILE TO BED-FORMAT
